...
const navItems = [
  ...
  { path: '/chatbot', icon: <Bot size={28} />, activeIcon: <Bot size={28} weight="fill" />, label: 'Tonha' },
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-[var(--bg-color2)] border-r border-gray-700/50 p-4">
      ...
      <div className="border-t border-gray-700/50 pt-4">
        ...
        <button onClick={() => handleNavigate('/minha-conta')} className="flex items-center gap-3 mb-4 p-2 w-full rounded-lg hover:bg-gray-700/50 transition-colors">
          <img
